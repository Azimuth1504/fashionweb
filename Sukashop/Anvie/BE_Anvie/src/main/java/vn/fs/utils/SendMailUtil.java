...
public class SendMailUtil {
	...
	private String getOrderDetailProductName(OrderDetail orderDetail) {
		if (orderDetail.getProduct() != null && orderDetail.getProduct().getName() != null) {
			return orderDetail.getProduct().getName();
		}
		return orderDetail.getProductName() != null ? orderDetail.getProductName() : "";
	}

	private String getOrderDetailProductImage(OrderDetail orderDetail) {
		if (orderDetail.getProduct() != null && orderDetail.getProduct().getImage() != null) {
			return orderDetail.getProduct().getImage();
		}
		return orderDetail.getProductImage() != null ? orderDetail.getProductImage() : "";
	}
	...
	public void sendMailOrder(Order order) {
		...
		for (OrderDetail oderDetail : listOrderDetails) {
			content.append("<tr>\r\n"
					...
					+ getOrderDetailProductImage(oderDetail) + ">\r\n"
					+ "                                                    </td>\r\n"
					...
					+ getOrderDetailProductName(oderDetail) + " </td>\r\n"
					+ "                                                    <td width=\"25%\" align=\"left\" style=\"font-family: Open sans-serif; font-size: 18px; font-weight: 400; line-height: 24px; padding: 15px 10px 5px 10px;\"> "
	...
	static String HEADERDELIVER = "<body style=\"margin: 0 !important; padding: 0 !important; background-color: #5B3236;\" bgcolor=\"#5B3236\">\r\n"
			...
			+ "                                            <img src=\"https://res.cloudinary.com/dr2herdsf/image/upload/v1767079068/logo_cake_house_gskbfi.png\" width=\"220px\"/>\r\n"
			+ "                                        </td>\r\n" + "                                    </tr>\r\n"
			+ "                                </table>\r\n" + "                            </div>\r\n"
			+ "                            \r\n" + "                        </td>\r\n" + "                    </tr>\r\n"
			+ "                    <tr>\r\n"
